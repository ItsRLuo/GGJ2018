...
public class VRfreeGlove : MonoBehaviour {
    ...
    void Update () {
        ...
        if(calibrationPoseShown) {
            ...
            if (wristTransform != null) { wristTransform.position = handData.wristPosition; wristTransform.rotation = handData.wristRotation; wristTransform.position += wristTransform.forward * 5.0f; }
